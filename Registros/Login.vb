...
Public Class Login
    ...
    Private Sub login_button_Click(sender As Object, e As EventArgs) Handles login_button.Click
        ...
        Try
            conexion.ConnectionString = "Server=127.0.0.1;User ID=root;Password=root;Database=user_acces;Port=3308;"
            conexion.Open()
            'MsgBox("Conectado")
        ...
        comando.CommandText = "select * from usuario_acceso where usuario = '" + User_txt.Text + "' and contrasena = '" + TextBox1.Text + "'"
